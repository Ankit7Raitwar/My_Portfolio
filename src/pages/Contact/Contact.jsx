...
const handleChange = (e) => {
    ...
    setFormData({
      ...formData, // Keep previous data intact
      [name]: value, // Update specific field using the name
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      emailjs.init('75QJwBssSjny8gYRk'); 

      emailjs.sendForm(
        'service_vzc6j4g', 
        'template_ov85k1a', // Your EmailJS template ID
        e.target, // The form itself
        '75QJwBssSjny8gYRk' // Your EmailJS user ID
      )
      .then(
        (response) => {
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">ankitraitwar@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Bhopal,MP(IN)</p>
                  </div>
                </div>
              </div>
            </div>
