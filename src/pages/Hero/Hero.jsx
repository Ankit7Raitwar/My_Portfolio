...
import myRusume from "../../assets/images/Ankit_Raitwar.pdf"
...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & Creator of UI Framework",
    "Learning MARN Stack",
...
const profile = {
    name: 'Ankit Raitwar',
    title: 'Front-End Developer | UI Framework Creator | Full-Stack in Progress',
    skills: [
        'React', 'React-Native', 'Next.js', 'Redux',
    'Node.js', 'Express', 'MongoDB', 'MySQL',
    'TypeScript', 'Git', 'Linux', 'REST APIs',
    'UI/UX Design', 'Open Source', 'Frontend Architecture'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | UI Framework Creator 🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Ankit7Raitwar"
