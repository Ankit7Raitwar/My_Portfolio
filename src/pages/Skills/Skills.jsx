  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: "React", icon: <FaReact className="w-4 h-4 text-[#61DAFB]" /> },
         { name: "React-Native", icon: <TbBrandReactNative className="w-4 h-4 text-[#61DAFB]" /> },
        {
          name: "JaveScript",
          icon: <SiJavascript className="w-4 h-4 text-orange-400" />,
        },
        {
          name: "Next.js",
    ...
    // },
    {
      ...
      skills: [
        ...
        { name: "Shopify", icon: <FaShopify className="w-4 h-4 text-green-400" /> },
        {
          name: "Firebase",
        ...
        { name: "Postman", icon: <SiPostman className="w-4 h-4 text-orange-400" /> },
      ],
    },
    {
      icon: Paintbrush,
